public class Idman {
    ...
    public void burpeeYap(int sayi){
        ...
        if(burpee_sayisi - sayi< 0){
            System.out.println("hedeflediiğin burpeeyi gectin");
            burpee_sayisi=0;
    ...
    public void pushupYap(int sayi){
        ...
        if(pushup_sayisi - sayi< 0){
            System.out.println("hedeflediiğin pushupi gectin");
            pushup_sayisi=0;
    ...
    public void situpYap(int sayi){
        ...
        if(situp_sayisi - sayi< 0){
            System.out.println("hedeflediiğin situpi gectin");
            situp_sayisi=0;
    ...
    public void squatYap(int sayi){
        ...
        if(squat_sayisi - sayi< 0){
            System.out.println("hedeflediiğin squati gectin");
            squat_sayisi=0;
